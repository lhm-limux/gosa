...
-----END PGP PRIVATE KEY BLOCK-----"""
    ...
    #print "createDistribution:", manager.createDistribution("debian", "deb", {"mirror": "http://archive.debian.org/debian"})
    ...
    #print(manager.getReleases(distribution = "debian"))
    #print(manager.getReleases())
    #print("removeRelease: ", manager.removeRelease(release = "lenny/1.0"))
    #print(manager.getReleases())
