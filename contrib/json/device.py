...
class DiskDefinition(object):
    ...
    @NamedArgs("m_hash")
    def addPartition(self, target, size, m_hash=None, maxSize=None, grow=False,
    ...
    @NamedArgs("m_hash")
    def addVolume(self, target, name, volGroup, m_hash=None, size=None, maxSize=None,
        grow=False, formatVolume=True, useExisting=False, fsType=None, fsOptions=None):
